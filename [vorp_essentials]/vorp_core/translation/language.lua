Translation = {
    English      = {
       Notify = {
    testText = "Dette er en testnotifikasjon",
    userNonExistent = "ID er feil eller brukeren eksisterer ikke.",
    ReadSuggestion = "Vennligst les chatforslagene om hvordan du bruker kommandoen.",
    SetGroup = "Du ga gruppe til ID: %d",
    SetGroup1 = "Admin ga deg gruppe av %s",
    AddJob = "Du ga jobben %s til ID %d Grad %d",
    AddJob1 = "Personale ga deg jobb %s Grad %d",
    error = "skriv 0 for kontanter og 1 for gull",
    AddMoney = "Du ga valuta %d til ID %d",
    AddMoney1 = "Mottok fra admin et bel�p p� %d",
    invfull = "inventaret er fullt",
    cantcarry = "kan ikke b�re mer av denne gjenstanden",
    removedcurrency = "Du har fjernet %d $ fra ID: %d",
    revived = "spiller med server-ID %d har blitt gjenopplivet",
    radius = "radiusen m� v�re h�yere enn 1",
    namechange = "Navnet ditt har blitt endret til: %s %s av en admin",
    banned = "ble permanent utestengt",
    banned2 = "utestengte noen til ",
    banned3 = "Du ble permanent utestengt!",
    healself = "Du gjenopplivet deg selv.",
    healall = "Du har blitt helbredet.",
    healedPlayer = "spiller med server-ID %d har blitt helbredet",
    AddItems = "Gjenstand %s med antall %d lagt til i inventaret ditt",
    AddWeapons = "V�pen lagt til i inventaret ditt",
            left = {
                title = "~e~IMPORTANT!",
    ...
    MessageOfSystem = {
    IsConnected = "?? Tilgang Nektet: Duplisert konto oppdaget (Steam | Rockstar)",
    TwoAccounts = "?? Tilgang Nektet: Fors�kt innlogging med en annen konto.",
    TwoAccounts2 = "?? Tilgang Nektet: Steam-ID allerede registrert p� serveren.",
    AccountEarlyLoad = "?? Tilgang Nektet: Konto lastes inn.",
    AccountEarlyLoad2 = "?? Tilgang Nektet: Dobbel lasting av konto ikke tillatt.",
    NoSteam = "?? Steam Kreves: Vennligst �pne Steam og start RedM p� nytt.",
    NoDiscord = "?? Discord Kreves: Vennligst �pne Discord og start RedM p� nytt.",
    NoInWhitelist = "?? Tilgang Nektet: Bruker ikke p� hvitelisten. Vennligst send ditt Steam-ID i Discord: ",
    NoPermissions = "Du har ikke nok tillatelser",
    CheckingIdentifier = "Sjekker identifikatorer",
    LoadingUser = "Laster inn bruker",
    BannedUser = "Du er utestengt til ",
    DropReasonBanned = "Du ble utestengt fra serveren til ",
    Warned = "Du ble advart",
    Unwarned = "Du ble uadvart",
    TitleOnDead = "Gj�r /alertdoctor i chatten for � be om legehjelp", 
    SubTitleOnDead = "Du kan gjenoppst� om %s sekunder",
    SecondsMove = " sekunder",
    YouAreCarried = "Du blir b�ret av en person",
    promptLabel = "Gjenoppst�",
    prompt = "Gjenoppst�",
    wayPoint = "~e~Du m� sette et veipunkt f�rst!",
    mustBeSeated = "~e~Du m� v�re i f�rersetet!",
    wagonInFront = "~e~Du m� v�re sittende eller n�r en vogn for � slette den!",
    cantCarry = "~e~Kan ikke b�re flere v�pen!",
    Hold = "HOLD P�!!",
    Load = "Du v�kner opp",
    Almost = "Nesten der...",
    Holddead = "DU ER D�D",
    Loaddead = "du forlot serveren mens du var d�d",
    forcedrespawn = "DU VIL BLI GJENOPPST�TT",
    forced = "Fordi du forlot serveren mens du var d�d",
    sit = "du m� v�re sittende",
    PVPNotifyOn = "PVP P� ",
    PVPNotifyOff = "PVP Av",
    AddChar = "La til Flere karakterer ",
    RemoveChar = "Fjernet Flere karakterer ",
    WrongHex = "Hex ikke i DB eller Feil Hex",
    myjob = "jobben din er: ~o~",
    mygrade = " ~q~grad: ~o~",
    charhours = "dine karaktertimer er: ~o~ %d",
    playhours = "spilte timer er: ~o~ %d",
    RespawnIn = "Du kan gjenoppst� om ",
    message = " eller " .. " /calldoctor",
    message2 = "Tiden har passert gjenoppst�",
    message3 = "Du m� vente til du kan gjenoppst�",
    message4 = "Spiller-ID ",
    message5 = "du ble skadet, if�lge regelen m� du glemme de siste 30 minuttene",
    message6 = "Gjenoppst�!!!",
    permanentlyBan = "Du er permanent utestengt!",
    PlayerWhenFocus = "Spiller",
},
        SuggestChat     = {
