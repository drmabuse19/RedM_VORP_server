...
Translation.Langs = {
  English = {
    ReadyToFish = "Er du klar for fisk!",
    PrepRod = "Gj�r klar fiskestang",
    ThrowHook = "Kast ut sn�ret",
    YourGot = "Du har en",
    --------------------------------
    Fishing = "Fiske",
    HookFish = "Krok",
  ...
  Portuguese_PT = {
    ...
    ReelLure = "Puxar o isco",
    --------------------------------
    MiniGame = "Apanha o peixe!",
    ReelIn = "Puxar o peixe",
    Cancel = "Recolher a linha",
    --------------------------------
    FishName = "Nome",
    FishWeight = "Peso",
  ...
  Spanish = {
    ReadyToFish = "Preparado/a para Pescar!",
    ...
    ReelLure = "Carnada",
    --------------------------------
    MiniGame = "Captura al Pez!",
    ReelIn = "Recuperar Carnada",
    Cancel = "Recoger el Anzuelo",
    --------------------------------
    FishName = "Nombre",
    FishWeight = "Peso",
