...
Config3.Stores = {
    ...
    Moonshiner = {	   -- you can add more wep markets by copy pasting this 
        Pos = {x = -2775.05, y = -3056.71, z = -12.34}, -- location of wep market 
        ...
        PromptName = "Svartemarket ",
        StoreOpen = 7, -- am
        StoreClose = 21, -- pm
        Name = 'Svartemarket', -- Store name 
        BlipName = "Svartemarket", -- blip name
        SpawnNPC = true,
        NpcModel = "U_M_M_NBXShadyDealer_01",
          weapons = { ["Elephant Rifle"] = {	
