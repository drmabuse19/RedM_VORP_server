Config = {}
Config.framework = "vorp" --"redemrp" or "redemrp-reboot" or "qbr" or "qbr2" or "vorp" | CHANGE THE SQL PATH IN FXMANIFEST TOO IF USING DIFFERENT THAN DEFAULT ("redemrp-reboot")
Config.VorpNotif = false 
Config.menuapi = "menuapi" --"redemrp_menu_base" or "menuapi"
