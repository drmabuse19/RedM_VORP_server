...
ConfigMining.DiamondChance = math.random(1, 150) --it will be a mathrandom from 1 to what ever you want.
ConfigMining.GoldChance = math.random(1, 30) --it will be a mathrandom from 1 to what ever you want.
...
ConfigMining.UseAnnesburg = true
ConfigMining.AnnesburgBlip = true
...
ConfigMining.UseTumbleWeed = true
ConfigMining.TubmleWeedBlip = true
