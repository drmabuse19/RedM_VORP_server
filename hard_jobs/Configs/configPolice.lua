...
Config.Zones = {
  ...
  PoliceDutybw = {
    	Pos = { x = -275.271, y = 801.388, z = 119.399 },
  },

	PoliceDutyval = {
    	Pos = { x = -754.170654, y = -1269.251, z = 44.038 },
  },

	PoliceDutystrw = {
	Pos = { x = -1799.279, y = -360.603, z = 163.351 },
  },

	PoliceDutyrhod = {
	Pos = { x = 1358.253, y = -1308.152, z = 77.729 },
  },


	PoliceDutysaint = {
	Pos = {x = 2507.95, y = -1301.39, z = 48.95},
  },
}

Config.Locale = "en"

Config.oro_1             = 'Searching gold.'
Config.oro_2             = 'Searching gold..'
Config.oro_3             = 'Searching gold...'
Config.oro_encontrado    = 'You found some gold.'
Config.oro_no_encontrado = 'You haven\'t found anything.'
Config.oro_no_recoger    = 'You can\'t find gold here.'
