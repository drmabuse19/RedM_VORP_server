...
----------------------------- TRANSLATE HERE -------------------------------------
Config.Language = {
    NotHoldingAnimal = "Du har ikke noe å selge",
    NotInTheButcher = "NEI! Det vil jeg ikke ha!",
    AnimalSold = "Takk for handelen!",
    SkinnableAnimalstowed = "Mottok ",
    stow = "Legg her",
    press = "Trykk",
    sell = "Slakter",
    notabutcher = "Du har ikke riktig jobb",
    dollar = " $",
    join = ", ",
    FullInventory = "Sekken er full!"
}
